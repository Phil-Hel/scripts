...
bash_prompt() {
	...
	if [ "$HOSTNAME" = sharkoon ]; then
		FONT_COLOR_1=$RED; BACKGROUND_1=$L_CYAN; TEXTEFFECT_1=$BOLD
		FONT_COLOR_2=$WHITE; BACKGROUND_2=$L_BLUE; TEXTEFFECT_2=$BOLD
	...
	if [ "$HOSTNAME" = aphrodite ]; then
		FONT_COLOR_1=$RED; BACKGROUND_1=$GREEN; TEXTEFFECT_1=$BOLD
